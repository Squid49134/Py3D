...
def ECons(Run = None):
    if Run == None:
        ...
        num = str(raw_input('How many times has sim restarted? \n'))
    if int(num) == 0: 
        ...
        pathStdoutRestart = '/global/cscratch1/sd/ransom/'+ str(Run) + '/staging/p3d.stdout.00' + num
